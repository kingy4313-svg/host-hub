    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-block rounded-full bg-[color:var(--gold)] px-6 py-2 text-base font-semibold text-black uppercase tracking-widest shadow-[0_0_18px_rgba(255,215,0,0.35)] hover:scale-105 transition-transform"
          >
            Go home
          </Link>
        </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premium event anchoring across India & abroad." },
      { name: "author", content: "Sayanti Banerjee" },
